package com.spencerwebsitedesign.layoutsbuttonstextareas1;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onYesButtonClick(View view) {
        ...
        // Open a Toast
        // It's a little gray popup at the bottom of the screen with a note inside it
        String usersName = String.valueOf(usersNameEditText.getText());

        String yourYesReponse = "That is great weather, " + usersName +".";

        // Indicate how long the Toast should stay open
        Toast.makeText(this, yourYesReponse, Toast.LENGTH_SHORT).show();
    }
    ...
    public void onNoButtonClick(View view) {
        ...
        String yourNoResponse = "That is a bummer, " +usersName +".";
